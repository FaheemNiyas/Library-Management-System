                ...
                <div class="col-12 hero-text-image">
                    <div class="row">
                        <div class="col-lg-12 text-center mb-5">
                            <h1 data-aos="fade-right">Books Gallery</h1>
                ...
                <div class="col-md-3" id="myUl">
                    <div class="card shadow p-3 mb-5 bg-white">
                        <div class="card-body">
                            ...
                            <form method="POST" action="borrow_funct.php">
                                <input type="hidden" value="<?php echo $row['bookname']; ?>" name="bookname">
                                <div class="text-center">

                                    <button type="submit" class="btn btn-dark btn-sm"> Borrow Book</a>
                                </div>
                            </form>
                        </div>
                    </div>

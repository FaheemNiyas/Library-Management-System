...
if (isset($_POST['update'])) {
    ...
    $update = "UPDATE `members` SET `username`='$username',`email`='$email',`password`='$password',`mobile_no`='$mobile' WHERE `id`= '$id'";
...
if (isset($_GET['id'])) {
    ...
    $update = "SELECT * FROM `members` WHERE `id` = '$id' ";
            ...
            <div class="wrapper">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container mt-5 mb-5 pt-3 pb-4 shadow bg-white" style="width: 80vh;">
                        <h3 class="mt-2 text-center pb-3 ">Update Members</h3>
                        <form method="POST">
                            ...
                            <div class="row justify-content-center">
                                <div>
                                    ...
                                    <a href="members.php" class="btn btn-secondary">Members</a>
                                </div>
                            </div>

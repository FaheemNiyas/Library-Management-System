    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="container mt-5 mb-5 pt-3 pb-4 shadow bg-white" style="width: 80vh;">
                <h3 class="mt-2 text-center pb-3 ">Upload Books</h3>
                <form action="book_config.php" method="POST" enctype="multipart/form-data">
                    <div class="row justify-content-center pb-3">
                        <div class="col-auto">
                            <input type="text" name="bookname" class="form-control" style="width: 31vh;" placeholder="Book Name">
                        </div>
                    </div>
                    <div class="row justify-content-center pb-3">
                        <div class="col-auto">
                            <input type="text" name="author" class="form-control" style="width: 31vh;" placeholder=" Author">
                        </div>
                    </div>
                    <div class="row justify-content-center pb-3">
                        <div class="col-auto ">
                    ...
                    <div class="row justify-content-center pb-3">
                        <div class="col-auto">
                            <input type="text" name="cat_id" class="form-control" style="width: 31vh;" placeholder=" Category Number">
                        </div>
                    </div>
                    <div class="row justify-content-center pb-3">
            ...
            <div class="container mt-1 mb-4 p-3 shadow bg-white">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        $select = "SELECT * FROM image LIMIT 500";
                        ...
                        while ($row = $result->fetch_assoc()) : ?>
                            ...
                            <tr>
                                <td><?= "<img src='book_img/" . $row['image'] . "'style=width:100px; height:100px;/>"; ?></td>

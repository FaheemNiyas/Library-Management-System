...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <h2 class="text-center ">U Library Members</h2>

            <div class="container mt-4 mb-5 pt-3 pb-4 shadow bg-white">
                <h3 class="mt-2 text-center pb-3">Create Members</h3>
                <form action="create_member.php" method="POST">
                    <div class="row justify-content-center">
                        ...
                        <div>
                            <button type="submit" name="create" class="btn btn-info">Create</button><br><br>
                        </div>
                    </div>
